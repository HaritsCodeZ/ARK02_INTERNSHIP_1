...
<div x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false" class="relative py-2 hidden md:block">
    ...
    <div class="max-w-[1600px] mx-auto w-full h-[2px] bg-white/20 mb-12"></div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12 mb-16">
            ...
            <div class="flex flex-col items-start md:items-end md:text-right">
                ...
                <div class="flex flex-col items-start md:items-end">
                    <h4 class="text-[24px] font-bold mb-4 tracking-tight uppercase text-white">ARKOD SMART LOGITECH</h4>
            ...
            </div> </div> <div class="w-full h-[2px] bg-white/10 mb-8"></div>

        <div class="flex flex-col items-center justify-center space-y-8">
            <p class="text-[14px] font-bold tracking-[0.3em] uppercase text-white/60">© ARKOD 2026. ALL RIGHTS RESERVED</p>
            ...
            <div class="flex flex-wrap justify-center items-center gap-x-12 gap-y-6">
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-[17px] font-bold text-white">+60 18-911 6168</span>
                </div>
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-[17px] font-bold text-white">082-384 999</span>
                </div>
                <div class="flex items-center gap-3">
