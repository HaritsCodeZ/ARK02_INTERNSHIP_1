...
<head>
    ...
    <title>ARKOD | {{ __('Logistics Management') }}</title>
...
<section class="relative min-h-[80vh] flex items-center justify-center py-20 bg-white overflow-hidden">
    <div class="max-w-[1600px] mx-auto px-6 relative w-full">
        ...
        <!-- Decorative background elements hidden on small viewports -->
        ...
        <div class="relative z-10 text-center max-w-4xl mx-auto px-2">
            <h4 class="text-black font-bold text-base md:text-lg mb-4 tracking-wide">
                {{ __('Become an Arkod Agent') }}
            </h4>

            <!-- Optimized fluid text sizing to prevent viewport overflows -->
            <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-[900] text-black leading-[1.1] tracking-tight mb-8 break-words">
                {{ __('Turn your time') }} <br>
                <span class="block mt-1">{{ __('into opportunity') }}</span>
            </h1>

            <p class="text-black text-base md:text-lg lg:text-xl leading-relaxed mb-12 font-medium max-w-2xl mx-auto">
                {{ __('By partnering with ARKOD’s smart logistics platform, you gain access to new earning opportunities while delivering greater value to your customers.') }}
            </p>
            ...
            <div class="flex justify-center">
                <a href="https://docs.google.com/forms/d/e/1FAIpQLSfJS2DBaRSqA2G1FUrkKzZ6xX2QowdQw9_4Y0OR9MOdh23t7Q/viewform?pli=1"
                   ...
                   class="bg-[#FFD700] hover:bg-black hover:text-white text-black font-bold px-12 md:px-16 py-3.5 md:py-4 rounded-full text-sm md:text-base transition-all duration-300 shadow-[0_15px_30px_rgba(0,0,0,0.2)] hover:shadow-none transform hover:-translate-y-0.5 border-2 border-black tracking-wide">
                    {{ __('Join Now') }}
                </a>
            </div>
        </div>
...
<section class="py-6 bg-white">
    <div class="max-w-[1400px] mx-auto px-6">
        ...
        <h2 class="text-5xl font-[900] text-black text-center mb-20">{{ __('Benefits Overview') }}</h2>
        ...
        <div class="flex flex-col md:flex-row items-stretch justify-between text-center">
            ...
            <div class="flex-1 px-8 py-10 flex flex-col items-center">
                ...
                <h3 class="text-3xl font-[900] text-black mb-6 leading-tight">{{ __('Business') }} <br> {{ __('Growth') }}</h3>
                <p class="text-black text-l font-semibold leading-relaxed max-w-[280px]">
                    {{ __('Expand your reach by tapping into ARKOD’s logistics network and access more delivery opportunities to grow your income.') }}
                </p>
            </div>
            ...
            <div class="flex-1 px-8 py-10 flex flex-col items-center">
                ...
                <h3 class="text-3xl font-[900] text-black mb-6 leading-tight">{{ __('Exclusive Member') }} <br> {{ __('Rate') }}</h3>
                <p class="text-black text-l font-semibold leading-relaxed max-w-[280px]">
                    {{ __('Enjoy special pricing and cost advantages available only to ARKOD agents, helping you stay competitive.') }}
                </p>
            </div>
            ...
            <div class="flex-1 px-8 py-10 flex flex-col items-center">
                ...
                <h3 class="text-3xl font-[900] text-black mb-6 leading-tight">{{ __('Rewards and') }} <br> {{ __('Bonuses') }}</h3>
                <p class="text-black text-l font-semibold leading-relaxed max-w-[280px]">
                    {{ __('Earn additional incentives through performance-based rewards, bonuses, and recognition programs.') }}
                </p>
            </div>
        ...
        <div class="bg-[#FFD700] rounded-[3rem] p-10 md:p-16 flex flex-col lg:flex-row items-center justify-between relative overflow-hidden animate-card-pulse border-4 border-black/5">
            ...
            <div class="w-full lg:w-3/5 z-10 text-center lg:text-left">
                <h2 class="text-4xl md:text-5xl font-[900] text-black mb-8 leading-tight">
                    {{ __('Discover new opportunity with us !') }}
                </h2>

                <p class="text-black text-lg md:text-xl font-semibold leading-relaxed mb-10 max-w-2xl">
                    {{ __('Explore a range of flexible delivery opportunities, simple workflows, and real earning potential — all designed to help you work smarter and earn on your own terms.') }}
                </p>

                <div class="space-y-6">
                    <p class="text-black font-[900] text-xl uppercase tracking-tight">
                        {{ __('Interested? Join us Now') }}
                    </p>
        ...
        <div x-data="{ active: 0 }" class="space-y-4">
            ...
            <div class="rounded-[2rem] overflow-hidden transition-all duration-300 shadow-sm border border-black/5">
                <button @click="active = (active === 1 ? null : 1)"
                    ...
                    <span class="text-lg md:text-xl font-[900] text-black">{{ __('1. Where can i view my tasks/delivery information?') }}</span>
                ...
                <div x-show="active === 1" x-collapse x-cloak class="bg-[#86D9F7] px-10 py-8">
                    <p class="text-black font-semibold text-lg leading-relaxed">{{ __('Login to the ARKOD agent Portal') }}</p>
                </div>
            </div>
            ...
            <div class="rounded-[2rem] overflow-hidden transition-all duration-300 shadow-sm border border-black/5">
                <button @click="active = (active === 2 ? null : 2)"
                    ...
                    <span class="text-lg md:text-xl font-[900] text-black">{{ __('2. What is the purpose of scanning the QR code?') }}</span>
                ...
                <div x-show="active === 2" x-collapse x-cloak class="bg-[#86D9F7] px-10 py-8">
                    <p class="text-black font-semibold text-lg leading-relaxed">{{ __('To provide ease of operation for the delivering agent to update delivery status and view a specific task description through the waybill “QR code”.') }}</p>
                </div>
            </div>
            ...
            <div class="rounded-[2rem] overflow-hidden transition-all duration-300 shadow-sm border border-black/5">
                <button @click="active = (active === 3 ? null : 3)"
                        ...
                        class="w-full flex items-center justify-between px-10 py-6 text-left transition-colors">
                    <span class="text-lg md:text-xl font-[900] text-black">{{ __('3. What if an accident occured, loss or any unfavoured circumstances happen?') }}</span>
                ...
                <div x-show="active === 3" x-collapse x-cloak class="bg-[#86D9F7] px-10 py-8">
                    <p class="text-black font-semibold text-lg leading-relaxed">{{ __('The compensation of loss or damaged item will be covered by the agent.') }}</p>
                </div>
            </div>
            ...
            <div class="rounded-[2rem] overflow-hidden transition-all duration-300 shadow-sm border border-black/5">
                <button @click="active = (active === 4 ? null : 4)"
                        ...
                        class="w-full flex items-center justify-between px-10 py-6 text-left transition-colors">
                    <span class="text-lg md:text-xl font-[900] text-black">{{ __('4. Can i change the collection/pickup time with the customers?') }}</span>
                ...
                <div x-show="active === 4" x-collapse x-cloak class="bg-[#86D9F7] px-10 py-8">
                    <p class="text-black font-semibold text-lg leading-relaxed">{{ __('Yes. The agent is required to inform ARKOD customer support and the customer before collection/pickup time.') }}</p>
                </div>
            </div>
            ...
            <div class="rounded-[2rem] overflow-hidden transition-all duration-300 shadow-sm border border-black/5">
                <button @click="active = (active === 5 ? null : 5)"
                        ...
                        class="w-full flex items-center justify-between px-10 py-6 text-left transition-colors">
                    <span class="text-lg md:text-xl font-[900] text-black">{{ __('5. What is the meaning of "manpower required"?') }}</span>
                ...
                <div x-show="active === 5" x-collapse x-cloak class="bg-[#86D9F7] px-10 py-8">
                    <p class="text-black font-semibold text-lg leading-relaxed text-sm">{{ __('Manpower required means the Van/Lorry driver needs to bring an extra helper to assist in the loading and unloading. The number of manpower required would mean the number of helpers requires, not including the driver.') }}</p>
                </div>
            </div>
            ...
            <div class="rounded-[2rem] overflow-hidden transition-all duration-300 shadow-sm border border-black/5">
                <button @click="active = (active === 6 ? null : 6)"
                        ...
                        class="w-full flex items-center justify-between px-10 py-6 text-left transition-colors">
                    <span class="text-lg md:text-xl font-[900] text-black">{{ __('6. What should i do if the parcel cannot be delivered on the stated date?') }}</span>
                ...
                <div x-show="active === 6" x-collapse x-cloak class="bg-[#86D9F7] px-10 py-8">
                    <p class="text-black font-semibold text-lg leading-relaxed">{{ __('Delivery Agent should update “Undelivered” with reason if the customer is not available or request to change the delivery date.') }}</p>
                </div>
            </div>
            ...
            <div class="rounded-[2rem] overflow-hidden transition-all duration-300 shadow-sm border border-black/5">
                <button @click="active = (active === 7 ? null : 7)"
                        ...
                        class="w-full flex items-center justify-between px-10 py-6 text-left transition-colors">
                    <span class="text-lg md:text-xl font-[900] text-black">{{ __('7. Can i cancel my delivery after accepting the delivery task?') }}</span>
                ...
                <div x-show="active === 7" x-collapse x-cloak class="bg-[#86D9F7] px-10 py-8">
                    <p class="text-black font-semibold text-lg leading-relaxed">{{ __('Once the task/assignment is accepted, it CAN NOT be cancelled unless there are last minutes changes. Please notify or provide your reason. Multiple cancellations will lead to your account suspension.') }}</p>
                </div>
            </div>
            ...
            <div class="rounded-[2rem] overflow-hidden transition-all duration-300 shadow-sm border border-black/5">
                <button @click="active = (active === 8 ? null : 8)"
                        ...
                        class="w-full flex items-center justify-between px-10 py-6 text-left transition-colors">
                    <span class="text-lg md:text-xl font-[900] text-black">{{ __('8. What if the sender or receiver is not present during pickup/delivery?') }}</span>
                ...
                <div x-show="active === 8" x-collapse x-cloak class="bg-[#86D9F7] px-10 py-8">
                    <p class="text-black font-semibold text-lg leading-relaxed">{{ __('Agents are required to call sender/receiver for availability. Reschedule for the following available day. You can leave the parcel at the door ONLY with consent and proof of photos/message.') }}</p>
                </div>
            </div>
            ...
            <div class="rounded-[2rem] overflow-hidden transition-all duration-300 shadow-sm border border-black/5">
                <button @click="active = (active === 9 ? null : 9)"
                        ...
                        class="w-full flex items-center justify-between px-10 py-6 text-left transition-colors">
                    <span class="text-lg md:text-xl font-[900] text-black">{{ __('9. Do you accept sub-contractors?') }}</span>
                ...
                <div x-show="active === 9" x-collapse x-cloak class="bg-[#86D9F7] px-10 py-8">
                    <p class="text-black font-semibold text-lg leading-relaxed">{{ __('Yes. Sign-up for an agent account and email us your interest. We will contact you to discuss your future task.') }}</p>
                </div>
            </div>
            ...
            <div class="rounded-[2rem] overflow-hidden transition-all duration-300 shadow-sm border border-black/5">
                <button @click="active = (active === 10 ? null : 10)"
                        ...
                        class="w-full flex items-center justify-between px-10 py-6 text-left transition-colors">
                    <span class="text-lg md:text-xl font-[900] text-black">{{ __('10. How do i get paid after completing the task?') }}</span>
                ...
                <div x-show="active === 10" x-collapse x-cloak class="bg-[#86D9F7] px-10 py-8">
                    <p class="text-black font-semibold text-lg leading-relaxed">{{ __('Agents email invoice reports to billing@arkod.com.my. Payment is transferred every fortnightly, Friday.') }}</p>
                </div>
            </div>
