            ...
            <div class="max-w-7xl mx-auto text-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-x-20 gap-y-12 items-end">
                    <div class="flex flex-col items-center group md:translate-y-10">
                        ...
                        <h3 class="text-lg font-black text-black uppercase tracking-tighter text-center leading-tight">{{ __('Your health and Wellbeing') }}</h3>
                    ...
                    <div class="flex flex-col items-center group">
                        ...
                        <h3 class="text-lg font-black text-black uppercase tracking-tighter text-center leading-tight">{{ __('Your future and finance') }}</h3>
                        <div class="w-48 h-1.5 bg-yellow-400 mt-4 group-hover:w-60 transition-all duration-300"></div>
                    </div>
                    ...
                    <div class="flex flex-col items-center group md:translate-y-10">
                        ...
                        <h3 class="text-lg font-black text-black uppercase tracking-tighter text-center leading-tight">{{ __('Family team') }}</h3>
                        <div class="w-48 h-1.5 bg-yellow-400 mt-4 group-hover:w-60 transition-all duration-300"></div>
                    </div>
                </div>
            </div>
