...
<body class="bg-[#0a0a0a] font-montserrat antialiased text-white overflow-x-hidden">
        ...
        <div class="max-w-[1600px] mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center space-x-8">
                <div class="hidden xl:flex items-center space-x-8">
                    ...
                    <button class="text-white border-b-2 border-yellow-400 text-sm font-bold uppercase tracking-wider transition pb-1">
                        Membership
                    </button>
                </div>
